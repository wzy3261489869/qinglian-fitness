        ...
        ${recent.length ? recent.map(r => `
          <div class="rec">
            <div class="rec-main">
              ...
              <span class="rec-meta">${r.date} · ${({ run: '户外跑步 GPS', walk: '户外健走 GPS', ride: '户外骑行 GPS', hike: '户外徒步 GPS', trail: '户外越野跑 GPS', mountain: '户外登山 GPS', skate: '户外轮滑 GPS', ski: '户外滑雪 GPS' })[r.type] || r.doneCount + '/' + r.total + ' 动作'}
            ...
            <div class="rec-data">
              ...
              <div class="rd-sub">${['run', 'walk', 'ride', 'hike', 'trail', 'mountain', 'skate', 'ski'].includes(r.type) && r.distanceKm != null ? r.distanceKm.toFixed(2) + ' km · ' : ''}${r.minutes} 分钟</div>
            </div>
