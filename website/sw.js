...
const CACHE = 'qinglian-v15';
const ASSETS = ['./', './index.html', './style.css', './app.js', './diet-module.js', './training-plans.js', './rewards-module.js', './manifest.webmanifest', './icon.svg', './exercises-lib.json', './foods-lib.json'];
const restTimers = [];
